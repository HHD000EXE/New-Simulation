...
%             saveas(gcf,['D:\MATLAB\New_Simulation_Materials(4 inches)\Trajectory\Pacing\',strcat(strcat('Pos_',num2str(Pos)),strcat('Angle_',num2str(Ang))),'.jpg']);
%             clf(1111);
    end
end
...
%                 plot(i,mod((X_k_minus(Ang_show,pos_show,i) + HalfBodyDiag*cos(beta_rad+Theta_k_minus(Ang_show,pos_show,i)/180*pi))*10*2.54,(LogDiameter+LogSpacing)*10*2.54),'c*','markersize',10,'linewidth',1.5);
                ...
                plot(i,mod((X_k_minus(Ang,Pos,i) - HalfBodyDiag*cos(beta_rad+Theta_k_minus(Ang,Pos,i)/180*pi))*10*2.54,(LogDiameter+LogSpacing)*10*2.54),'c*','markersize',8,'linewidth',1.5);
            else %Second pair
...
%                 plot(i,mod((X_k_minus(Ang_show,pos_show,i) - HalfBodyDiag*cos(beta_rad+Theta_k_minus(Ang_show,pos_show,i)/180*pi))*10*2.54,(LogDiameter+LogSpacing)*10*2.54),'mo','markersize',8,'linewidth',1.5);
        ...
        set(gcf,'outerposition',get(0,'screensize'));
        saveas(gcf,['D:\MATLAB\New_Simulation_Materials(4 inches)\Contact_position\Pacing\',strcat(strcat('Pos_',num2str(Pos)),strcat('Angle_',num2str(Ang))),'.jpg']);
        clf(2);
    end
end
